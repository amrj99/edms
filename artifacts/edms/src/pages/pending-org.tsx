      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed max-w-sm mx-auto">
            Your account was created but hasn't been connected to an organisation yet.
            Create a new organisation to get started, or ask your administrator for an invitation.
          </p>
        </div>
        ...
        <Card className="border-dashed">
          <CardContent className="pt-5 space-y-3">
            <div className="text-center space-y-1">
              <p className="text-sm font-medium">Have an Invitation?</p>
            ...
            <div className="flex gap-2">
              <Input
                placeholder="Enter invitation code (coming soon)"
                value={inviteCode}
                onChange={e => setInviteCode(e.target.value)}
                disabled
                className="text-sm"
              />
              <Button variant="outline" disabled size="icon" aria-label="Submit invitation code">
