...
const translations = {
  en: {
    ...
    moduleDesc_reports: "All 7 document registers: master, correspondence, transmittals, drawings, ITR/MIR, NCR/SOR, NOC",
    moduleDesc_correspondence: "Manage project correspondence, RFIs, and communication records",
    moduleDesc_documents: "Upload, revise, and control project documentation",
