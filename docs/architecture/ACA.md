...
3. **Authorization Path منفصل** — لا OR على `orgScopedWhere`:
   - استعلام مستقل يتحقق من: هل المستخدم ينتمي لـ Entity مشاركة؟ هل المشروع collaborative؟ هل الـ Resource ضمن الـ Ceiling الافتراضي للدور؟
...
- Organization A الـ internal projects: orgScopedWhere يعمل بلا تأثير
